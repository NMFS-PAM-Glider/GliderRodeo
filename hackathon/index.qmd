...
Our NOAA Fisheries objective is to develop open-source analysis and visualization tools that evaluate glider performance during the [Glider Rodeo](https://nmfs-pam-glider.github.io/GliderRodeo/), providing the community with a framework for future studies. We also welcome project that use these data to explore other participant objectives. 
...
- No experience is necessary, although **we hope all project team participants will participate all week** *(you can work with your team if you have other commitments!)*.
...
- Please review our [Code of Conduct](https://nmfs-pam-glider.github.io/GliderRodeo/hackathon/conduct.html), and lets make sure everyone feels welcome!
